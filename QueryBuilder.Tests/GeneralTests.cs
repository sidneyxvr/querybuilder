...
namespace SqlKata.Tests
{
    public class GeneralTests : TestSupport
    {
        ...
        public void AddOrReplace_Works(string table, string engine)
        {
            ...
            if (table != null)
                query.From(table);
            query.AddOrReplaceComponent(Component.From, new FromClause() { Table = "updated", Engine = engine });
        ...
        public void GetOneComponent_Prefers_Engine(string engine, string column)
        {
            ...
            var where = query.GetOneComponent(Component.Where, engine) as BasicCondition;
        ...
        public void AddOrReplace_Throws_MoreThanOne()
        {
            ...
            Assert.Throws<InvalidOperationException>(()
                => query.AddOrReplaceComponent(Component.Where,
                new BasicCondition
                {
                    Column = null,
                    Operator = null,
        ...
        public void OneLimitPerEngine()
        {
            ...
            var limits = query.GetComponents<LimitClause>(Component.Limit, EngineCodes.SqlServer);
        ...
        public void CompilerSpecificLimit()
        {
            ...
            Assert.Equal(2, query.GetComponents(Component.Limit).Count);
        ...
        public void OneOffsetPerEngine()
        {
            ...
            var limits = query.GetComponents<OffsetClause>(Component.Offset, EngineCodes.SqlServer);
            Assert.Single(limits);
        ...
        public void CompilerSpecificOffset()
        {
            ...
            Assert.Equal(2, query.GetComponents(Component.Offset).Count);
