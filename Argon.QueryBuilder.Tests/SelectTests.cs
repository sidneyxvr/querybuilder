...
namespace SqlKata.Tests
{
    public class SelectTests : TestSupport
    {
        ...
        public void BasicSelectWhereBindingIsEmptyOrNull()
        {
            ...
            Assert.Equal("SELECT `id`, `name` FROM `users` WHERE `author` = @p0 OR `author` IS NULL", c[EngineCodes.MySql]);
        ...
        public void UnionWithBindings()
        {
            ...
            Assert.Equal("SELECT * FROM `Phones` UNION SELECT * FROM `Laptops` WHERE `Type` = @p0", c[EngineCodes.MySql]);
        ...
        public void Limit()
        {
            ...
            Assert.Equal("SELECT `id`, `name` FROM `users` LIMIT @p0", c[EngineCodes.MySql]);
        ...
        public void Offset()
        {
            ...
            //    c[EngineCodes.SqlServer]);
            Assert.Equal("SELECT * FROM `users` LIMIT 18446744073709551615 OFFSET @p0", c[EngineCodes.MySql]);
        ...
        public void LimitOffset()
        {
            ...
            //    c[EngineCodes.SqlServer]);
            Assert.Equal("SELECT * FROM `users` LIMIT @p0 OFFSET @p1", c[EngineCodes.MySql]);
